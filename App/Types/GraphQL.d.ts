...
export interface FollowedListsQueryArgs {
  after: string | null;
  before: string | null;
  first: number | null;
  last: number | null;
...
export interface FriendsQueryArgs {
  after: string | null;
  before: string | null;
  first: number | null;
  last: number | null;
...
export interface ListsQueryArgs {
  after: string | null;
  before: string | null;
  first: number | null;
  last: number | null;
...
export interface ListsUserArgs {
  after: string | null;
  before: string | null;
  first: number | null;
  last: number | null;
...
export interface List {
  achievements: AchievementConnection | null;
...
export interface AchievementsListArgs {
  after: string | null;
  before: string | null;
  first: number | null;
  last: number | null;
...
export interface Unlocked extends NotificationInterface {
  achievement: Achievement;
  coop: boolean;
  coopBonus: number;
  createdAt: number;
...
export type NotificationKind = "ACHIEVEMENT_UNLOCKED" | "ACHIEVEMENT_UNLOCKED_COOP_BONUS" | "COOPERATION_REQUEST_ACCEPTED" | "COOPERATION_REQUEST_RECEIVED" | "COOPERATION_REQUEST_REJECTED" | "FRIEND_REQUEST_ACCEPTED" | "FRIEND_REQUEST_RECEIVED" | "REWARD_UNLOCKED" | "SHARED_ACHIEVEMENT_RECEIVED" | "SHARED_LIST_RECEIVED";

export interface ObjectiveConnection {
  edges: Array<ObjectiveEdge> | null;
  nodes: Array<Objective> | null;
  pageInfo: PageInfo;
}
...
export interface FollowListMutationArgs {
  input: FollowListInput;
}
...
export interface RejectListMutationArgs {
  input: RejectListInput;
}
...
export interface ShareAchievementMutationArgs {
  input: ShareAchievementInput;
}

export interface ShareListMutationArgs {
  input: ShareListInput;
}
...
export interface CoopRequest extends NotificationInterface {
  achievement: Achievement | null;
  createdAt: number;
  id: string;
  isAccepted: boolean;
...
export interface FriendRequest extends NotificationInterface {
  createdAt: number;
  id: string;
  isAccepted: boolean;
  message: string;
...
export type OauthProvider = "demo" | "google";
...
export interface ListsCurrentUserArgs {
  after: string | null;
  before: string | null;
  first: number | null;
  last: number | null;
...
export interface AchievementsRefreshSuggestedPayloadArgs {
  after: string | null;
  before: string | null;
  first: number | null;
  last: number | null;
...
export interface RejectListInput {
  clientMutationId: string | null;
  id: string;
}

export interface RejectListPayload {
  clientMutationId: string | null;
  errors: Array<string>;
  shareRequest: SharedList | null;
}

export interface SharedList extends NotificationInterface {
  id: string;
  isInvitable: boolean;
  list: List;
  receiver: User;
...
export interface RequestCoopPayload {
  clientMutationId: string | null;
  coopRequests: Array<CoopRequest>;
  errors: Array<string>;
}
...
export interface ShareAchievementPayload {
  clientMutationId: string | null;
  errors: Array<string>;
  shareRequests: Array<SharedAchievement>;
}

export interface SharedAchievement extends NotificationInterface {
  achievement: Achievement;
  createdAt: number;
  id: string;
  isInvitable: boolean;
...
export interface ShareListPayload {
  clientMutationId: string | null;
  errors: Array<string>;
  shareRequests: Array<SharedList>;
}
