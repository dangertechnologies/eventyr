...
import { Query, User } from "@eventyr/graphql";
...
import QUERY_USER_DETAILS from "@eventyr/graphql/Queries/Users/Details";
    ...
    return (
      <View style={{ flex: 1, flexDirection: "column-reverse" }}>
        ...
        >
          ...
          {user && this.props.selectedTab === 1 && (
            <UnlockedAchievements user={user} />
          )}

          {user && this.props.selectedTab === 0 && (
